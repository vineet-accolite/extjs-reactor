...
//                 <Column text="% Change" dataIndex="priceChangePct" encodeHtml={false} renderer={this.renderSign.bind(this, '0.00%')}/>
//                 <Column text="Last Updated" width="125" dataIndex="lastChange" formatter='date("m/d/Y")'/>
//             </Grid>
//         )
//     }
...
//       ReactDOM.render(<span style={{ color: value > 0 ? 'green' : value < 0 ? 'red' : ''}}>
//           {Ext.util.Format.number(value, format)}
//       </span>,widget.el.dom)
// //      debugger
//       return widget.el.dom.innerHTML
//     }
